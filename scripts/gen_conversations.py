...
AMBIGUOUS = [
    ...
    ("i can meet friday or sunday", "Friday works better for me - you?",
     "sunday actually", "Sunday then - afternoon or evening?",
     "they picked sunday over friday - lock in the time next."),
    ("want coffee or dinner", "Dinner's more fun - thoughts?",
     "nah", "Coffee it is - lower stakes anyway. Know a good spot?",
     "nah rejects dinner - fall back to the coffee option."),
    ("do you believe in aliens", "Statistically? Probably. You?",
     "definitely", "The math agrees - billions of planets, one had to hit. What convinced you?",
     "they said definitely - agree with the stats angle and probe their reason."),
    ("should i text them first", "Depends - what happened last time?",
     "they left me on read", "Then wait - one unanswered text is a signal, not a challenge.",
     "left on read = don't double text. advise restraint."),
    ("i got two job offers", "Nice problem to have - which pays better?",
     "about the same", "Then pick on growth and vibe, not salary. Which team felt better?",
     "equal pay - pivot the decision criteria to growth and fit."),
    ("red pill or blue pill", "Choosing blue keeps the story going - you?",
     "red obviously", "Red it is - welcome to the real world. Was it the curiosity?",
     "they chose red - riff on curiosity over comfort."),
    ("im learning two instruments", "Ambitious - which two?",
     "piano and drums", "Melody and rhythm - solid combo. Which one started first?",
     "they answered with piano and drums - ask which came first."),
    ("my cat and dog fight a lot", "Classic rivalry - who starts it usually?",
     "the cat", "Of course it's the cat. Does the dog retaliate or just take it?",
     "the cat is the instigator - continue with humor."),
    ("beach or mountains this weekend", "Mountains for the views - your pick?",
     "beach, no contest", "Beach wins - sunrise swim or lazy afternoon?",
     "they chose beach - narrow to a concrete plan."),
    ("i keep dreaming about flying", "Flying dreams usually mean wanting freedom. What do you think?",
     "nah just random", "Fair - sometimes a dream is just a dream. Sleep okay otherwise?",
     "they dismissed the interpretation - don't push, pivot."),
]
